        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManufactorDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AvailabilityForRent = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rents_Cars_CarsId",
                        column: x => x.CarsId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rents_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rents_CarsId",
                table: "Rents",
                column: "CarsId");

            migrationBuilder.CreateIndex(
                name: "IX_Rents_UsersId",
                table: "Rents",
                column: "UsersId");
        }
